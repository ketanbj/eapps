...
/*
 * Simplified macro to send an error system log message using a custom TAG.
 */
#ifndef EPHLOGE
#define EPHLOGE(custom_tag, ...) \
        ((void)__android_log_buf_print(LOG_ID_SYSTEM, ANDROID_LOG_ERROR, custom_tag, __VA_ARGS__))
#endif

/*
 * Simplified macro to send an INFO system log message using a custom TAG.
 */
#ifndef EPHLOGI
#define EPHLOGI(custom_tag, ...) \
