...
public class Activity extends ContextThemeWrapper
    ...
    public void startActivityForResultEphemeral(String pname,Intent intent,ApplicationInfo ainfo , Bundle options) {
        if (mParent == null) {
	/*FIXME get the package from eBox */
            Instrumentation.ActivityResult ar =
		mInstrumentation.execStartActivityEphemeral(pname, intent, ainfo, options);
            /*if (ar != null) {
                mMainThread.sendActivityResult(
                    mToken, mEmbeddedID, requestCode, ar.getResultCode(),
                    ar.getResultData());
            ...
            // TODO Consider clearing/flushing other event sources and events for child windows.
                  ...
                  mParent.startActivityFromChildEphemeral(pname,intent, ainfo, options);
        }
    ...
    @Override
    public void startActivityEphemeral(String pname, Intent intent, ApplicationInfo ainfo) {
        this.startActivityEphemeral(pname, intent, ainfo, null);
    }
    ...
    @Override
    public void startActivityEphemeral(String pname,Intent intent, ApplicationInfo ainfo,Bundle options) {
        /*FIXME get the package from eBox */
    	if (options != null) {
    		options.putString("eapp", "true");
    		startActivityForResultEphemeral(pname, intent, ainfo, options);
    	} else {
    		Bundle bundle = new Bundle();
    		bundle.putString("eapp", "true");
    		startActivityForResultEphemeral(pname, intent, ainfo, bundle);
    	}
    }
    ...
    public void startActivityFromChildEphemeral(String pname, Intent intent,ApplicationInfo ainfo, Bundle options) {
        Instrumentation.ActivityResult ar =
            mInstrumentation.execStartActivityEphemeral(pname, intent, ainfo,options);
        /*if (ar != null) {
