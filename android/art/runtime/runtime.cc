...
//FIXME
  ephemeral_linker_ = new EphemeralLinker();
  if(options->ephemeral_mode_){
	//ephemeral_linker_->OpenSocket();
        ephemeral_linker_->ReadEphemeralApps();
  }
