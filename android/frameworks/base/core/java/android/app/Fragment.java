...
public class Fragment implements ComponentCallbacks2, OnCreateContextMenuListener {
    ...
    public void startActivityEphemeral(String pname ,Intent intent, ApplicationInfo ainfo) {
        startActivityEphemeral(pname, intent, ainfo, null);
    }
    ...
    public void startActivityEphemeral(String pname, Intent intent, ApplicationInfo ainfo, Bundle options) {
        ...
        if (options != null) {
            ...
            mActivity.startActivityEphemeral(pname, intent, ainfo, options);
        } else {
            Bundle bundle = new Bundle();
            bundle.putString("eapp", "true");
            mActivity.startActivityEphemeral(pname, intent, ainfo, bundle);
        }
    }
