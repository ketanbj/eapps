...
//  gLogVerbosity.verifier = true;  // TODO: don't check this in!
    gLogVerbosity.ephemeral_linker = true; // TODO: don't check this in!
  ...
  for (size_t i = 0; i < options.size(); ++i) {
    ...
    if (StartsWith(option, "-help")) {
      ...
      for (size_t i = 0; i < verbose_options.size(); ++i) {
        ...
        } else if (verbose_options[i] == "ephemeral"){
          gLogVerbosity.ephemeral_linker = true;
	} else
	{
     ...
     else if (StartsWith(option, "-ephmode"))
     {
		ephemeral_mode_ = true;
     }
